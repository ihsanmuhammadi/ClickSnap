...
public class TransaksiUser extends javax.swing.JFrame {
    ...
    public TransaksiUser() {
        initComponents();
        trx = new TransactionController(null, null, this);
        trx.shwoTxUsr();
        
    }

    public TransaksiUser(Customer currentUser) {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Buy.png"))); // NOI18N
        ...
        jLabel3.setText("In this page, you can see all of your transactions!");
